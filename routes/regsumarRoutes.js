...
// view all sum
router.get('/sumarios', express.json(), async (req, res) => {
	try{
...
// create a sum
router.post('/sumario/create', express.json(), async (req, res) => {
	try{
...
// view a sum
router.get('/sumarios/:id', express.json(), async (req, res) => {
	try{
		const { id } = req.params;
...
// edit a sum
router.put('/sumarios/:id', express.json(), async (req, res) => {
	try{
...
// delete a sum
router.delete('/sumarios/:id', express.json(), async (req, res) => {
	try{
		const { id } = req.params;
